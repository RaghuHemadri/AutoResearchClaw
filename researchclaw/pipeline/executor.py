        ...
        if isinstance(parsed, dict):
            ...
            if llm is not None:
                ...
                _retry_prompt = (
                    ...
                    f"Topic: {config.research.topic}\n"
                    "Use exactly these keys in order: objectives, datasets, baselines, "
                    "proposed_methods, ablations, metrics, risks, compute_budget.\n"
                    "Rules: list keys must have 2-5 plain unquoted items; each item <= 160 chars. "
                    "compute_budget must be a mapping with integer keys max_gpu and max_hours.\n"
                    "Template:\n"
                    "objectives:\n"
                    "  - objective_1\n"
                    "  - objective_2\n"
